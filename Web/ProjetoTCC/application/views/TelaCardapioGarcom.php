...
<body>
    ...
    <div class="text-center my-auto cor2 borda sub">
        <ul>
            <li><a class="btn btn-danger" href="<?php echo base_url('index.php/Welcome/telaGarcom'); ?>" style="position: relative; right: 18px;">Voltar</a></li>
        </ul>
    </div>      
    <div class="container-fluid mt-4">
        <div class="wrapper">
            ...
            <?php foreach ($cardapio as $cardapios) : ?>
                <form class="card_item" action="<?php echo base_url("index.php/Welcome/itensCardapioGarcom")?>" method="post">
