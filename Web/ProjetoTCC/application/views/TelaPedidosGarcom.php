    ...
    <div class="d-none d-md-block">
        <div class="container-fluid mt-4" style="background-color: white; border: solid white 15px; border-radius: 10px;">
            <ul class="justify-content-end ">
                ...
                <li><a class="btn btn-danger" href="<?php echo base_url('index.php/Welcome/telaPedidosPendentesGarcom'); ?>">Pedidos Pendentes</a></li>
                <li><a class="btn btn-danger" href="<?php echo base_url('index.php/Welcome/telaPedidosConcluidosGarcom'); ?>">Pedidos Concluidos</a></li>
                <li><a class="btn btn-danger" href="<?php echo base_url('index.php/Welcome/telaPedidosEntreguesGarcom'); ?>">Pedidos Entregues</a></li>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="<?php echo base_url("index.php/Pedidos/validarStatusPedido");?>" method="POST" id="AlterararStatusGarcom">
