        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url("index.php/Itens/validarUpdateItens");?>" method="POST" id="UpdateCardapioItensGarcom">
                        <div class="form-row">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="<?php echo base_url("index.php/Itens/excluirItem");?>" method="POST" id="ExcluirItensGarcom">
